...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f2i.pack(_x.angular_thres, _x.trans_thres, _x.rate, _x.timeout.secs, _x.timeout.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angular_thres, _x.trans_thres, _x.rate, _x.timeout.secs, _x.timeout.nsecs,) = _struct_3f2i.unpack(str[start:end])
      self.timeout.canon()
      return self
