/* Auto-generated by genmsg_cpp for file /home/praktikum/labprogramr_1/ros-workspace/tf2_web_republisher/msg/TFSubscriptionAction.msg */
...
struct TFSubscriptionAction_ {
  ...
  typedef  ::tf2_web_republisher::TFSubscriptionActionGoal_<ContainerAllocator>  _action_goal_type;
   ::tf2_web_republisher::TFSubscriptionActionGoal_<ContainerAllocator>  action_goal;

  typedef  ::tf2_web_republisher::TFSubscriptionActionResult_<ContainerAllocator>  _action_result_type;
   ::tf2_web_republisher::TFSubscriptionActionResult_<ContainerAllocator>  action_result;

  typedef  ::tf2_web_republisher::TFSubscriptionActionFeedback_<ContainerAllocator>  _action_feedback_type;
   ::tf2_web_republisher::TFSubscriptionActionFeedback_<ContainerAllocator>  action_feedback;
...
{
template<class ContainerAllocator> struct IsMessage< ::tf2_web_republisher::TFSubscriptionAction_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::tf2_web_republisher::TFSubscriptionAction_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
